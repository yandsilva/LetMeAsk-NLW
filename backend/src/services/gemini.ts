...
export async function generateAnswer(
  ...
  const prompt = `
  Como base no texto fornecido abaixo como contexto, responda a pergunda de forma clara em português do Brasil
  ...
  - Se responta não for encontrada no contexto, apenas responda que não possui informções suficientes para responder.
  - Seja objetivo.
